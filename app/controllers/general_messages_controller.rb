class GeneralMessagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @general_message.save
        ...
        format.html { redirect_to root_path, notice: 'General message was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @general_message.update(post_params)
        format.html { redirect_to root_path, notice: 'General message was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'General message was successfully destroyed.' }
